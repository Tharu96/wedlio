...
<main class="mt-5">    
        <div class="container">
            ...
            <section id="best-features" class="text-center">
                ...
                <!-- Heading -->
                <h2 class="mb-5 font-weight-bold">Wedding Photographers in WEDLIO</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/s30001.jpg" class="responsive"alt="Card image cap">
                            <div class="card-body">
                    ...
                    <div class="card" style="width: 18rem;">
                    <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/home2.jpg" class="responsive"alt="Card image cap">
                        <div class="card-body">
                    ...
                    <div class="col-md-4 mb-1">
                    <div class="card" style="width: 18rem;">
                    <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/tworings1.jpg" alt="Card image cap">
                        <div class="card-body">
                    ...
                    <!--Grid column-->
                     ...
                     <div class="col-md-4 mb-1">
                     <div class="card" style="width: 18rem;">
                     <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/t13.jpg" alt="Card image cap">
                        <div class="card-body">
                    ...
                    <!--Grid column-->
                     ...
                     <div class="col-md-4 mb-1">
                     <div class="card" style="width: 18rem;">
                     <img class="card-img-top img-fluid " src="<?php echo base_url(); ?>assets/homepage/wedlio_img/krishphoto1.jpg" alt="Card image cap">
                        <div class="card-body">
                    ...
                    <!--Grid column-->
                     ...
                     <div class="col-md-4 mb-1">
                     <div class="card" style="width: 18rem;">
                     <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/k14.jpg" alt="Card image cap">
                        <div class="card-body">
