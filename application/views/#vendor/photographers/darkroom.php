...
<div id="slideshow" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    ...
    <img class="d-block w-100" src="<?php echo base_url();?>assets/homepage/wedlio_img/home6.jpg" alt="First slide " class="responsive"
    ...
    <div class="carousel-item">
    <img class="d-block w-100" src="<?php echo base_url();?>assets/homepage/wedlio_img/home3.jpg" alt="First slide " class="responsive"
        style="background-repeat: no-repeat; 
...
<div class="container">
    ...
    <!-- Section heading -->
    <h2 class="h1-responsive font-weight-bold mb-5">Dark Room Photography</h2>
            ...
            <div class="carousel-item active">
                <div class="testimonial">
                    ...
                    <div class="avatar mx-auto mb-4">
                        <img src="<?php echo base_url();?>assets/homepage/wedlio_img/danukadp.jpg" class="rounded-circle img-fluid"
                            alt="First sample avatar image">
                    </div>
                    <!--Content-->
                    <p>
                        <i class="fas fa-quote-left"></i> Danuka  Kumarasinghe  has  become  popular  as  one  of  the  most  talented  wedding photographer  in  the  industry.    Despite  his  age,  this  brilliant  young  individual  and  the team Dark Room specializes in the art of detail wedding photography
                    </p>
                    <h4 class="font-weight-bold"> Danuka  Kumarasinghe</h4>
                    <h6 class="font-weight-bold my-3">Founder Dark Room Photography</h6>
                    <!--Review-->
