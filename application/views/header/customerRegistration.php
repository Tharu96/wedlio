...
<div class="m-5">
    ...
    <br>
    <form onSubmit="return validate()" action="<?php echo base_url(); ?>index.php/registration/addCustomer"
        method="post" enctype="multipart/form-data" id="customerRegistration-form">
