...
<body> -->
	...
	<div class="m-5">
		...
		<hr>
		<p>Personnal Information Relevant To The Moderator Of The Business</p>
		...
		<form onSubmit="return validate()" action="<?php echo base_url(); ?>index.php/registration/addVendorTemp" method="post" enctype="multipart/form-data" id="customerRegistration-form">
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="inputbusinessRegNo">Business Registration Number</label>
					<!-- not required -->
					<input type="text" class="form-control" name="businessRegNo" id="inputbusinessRegname" placeholder="for registered Business">
				</div>
				<div class="form-group col-md-6">
					<label for="inputbusinessName">Business Name</label>
					<!-- required -->
					<input type="text" class="form-control" name="businessName" id="inputbusinessName" placeholder="ABC & co.">
				</div>
			</div>
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					...
					<select class="form-control" id="sel1" name="vendorcategory">
						...
						<option value="3">Reception Hall</option>
						<option value="4">Wedding Bands</option>
					</select>
				</div>
				<div class="form-group col-md-6"><br>
					<a href="<?php echo base_url(); ?>index.php/Category/addCategory" class="btn btn-primary" role="button">+ Add New Category</a>
					<!-- not required -->
				</div>
			</div>
			...
			<div class="form-row">
				<div class="form-group col-md-12">
					...
					<!-- not required -->
					<input type="text" class="form-control" name="description" id="inputdescription" placeholder="Small description about the business">
				</div>
			</div>

			<div class="form-row">
				<div class="form-group col-md-6">
					<label for="inputfirstname">Business Address</label>
					<!-- not required -->
					<input type="text" class="form-control" name="businessaddress" id="inputbusinessaddress" placeholder="123, Galle Rd, Colombo 03">
				</div>
			...
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					...
					<!-- required -->
					<input type="email" class="form-control" name="businessEmail" id="inputbusinessEmail" placeholder="Example@123">
				</div>
			</div>
			<div class="form-row">
