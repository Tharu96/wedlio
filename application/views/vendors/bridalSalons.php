...
<div id="slideshow" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    ...
    <img class="d-block w-100" src="<?php echo base_url();?>assets/homepage/wedlio_img/p2.jpg" alt="First slide " class="responsive"
...
<main class="mt-5">    
        <div class="container">
            ...
            <section id="best-features" class="text-center">
                ...
                <!-- Heading -->
                <h2 class="mb-5 font-weight-bold">Bridal Salons in WEDLIO</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/hotel2.jpg" class="responsive"alt="Card image cap">
                            <div class="card-body">
                                <a href="#"  class="btn btn-unique btn-sm " >Reception Venues</a>
                    ...
                    <div class="card" style="width: 18rem;">
                    <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/k10.jpg" class="responsive"alt="Card image cap">
                        <div class="card-body">
                        <a href="#"  class="btn btn-unique btn-sm " >Wedding Photographers</a>
                        </div>
                    </div>
                    </div>
                    <!--Grid column-->
                    ...
                    <div class="col-md-4 mb-1">
                    <div class="card" style="width: 18rem;">
                    <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/salons3.jpg" alt="Card image cap">
                        <div class="card-body">
                        <a href="#"  class="btn btn-unique btn-sm " >Bridal Salons</a>
                        </div>
                    </div>
                    </div>
                    <!--Grid column-->
                     ...
                     <div class="col-md-4 mb-1">
                     <div class="card" style="width: 18rem;">
                     <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/t10.jpg" alt="Card image cap">
                        <div class="card-body">
                        <a href="#"  class="btn btn-unique btn-sm " >DJ & Wedding Bands</a>
                        </div>
                    </div>
                    </div>
                    <!--Grid column-->
                     ...
                     <div class="col-md-4 mb-1">
                     <div class="card" style="width: 18rem;">
                     <img class="card-img-top img-fluid " src="<?php echo base_url(); ?>assets/homepage/wedlio_img/flora7.jfif" alt="Card image cap">
                        <div class="card-body">
                        <a href="#"  class="btn btn-unique btn-sm " >Florists</a>
                        </div>
                    </div>
                    </div>
                    <!--Grid column-->
                     ...
                     <div class="col-md-4 mb-1">
                     <div class="card" style="width: 18rem;">
                     <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/cake2.jpg" alt="Card image cap">
                        <div class="card-body">
                        <a href="#"  class="btn btn-unique btn-sm " >Wedding Cakes</a>
                        </div>
                    </div>
                    </div>
                    <!--Grid column-->
