                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top img-fluid" src="<?php echo base_url('uploads/'.$category->imagePath); ?>"class="responsive"alt="Card image cap">
                            <div class="card-body">
                            
                            <a class="btn btn-unique btn-sm" href="<?php echo base_url(); ?>index.php/Welcome/load_vendors/<?php echo $category->categoryId ?>"><?php echo $category->categoryName?></a>
