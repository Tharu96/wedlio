...
<div id="slideshow" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    ...
    <img class="d-block w-100" src="<?php echo base_url();?>assets/homepage/wedlio_img/photography.jpg" alt="First slide " class="responsive"
...
<main class="mt-5">    
        <div class="container">
            ...
            <section id="best-features" class="text-center">
                ...
                <!-- Heading -->
                <h2 class="mb-5 font-weight-bold">Reception Halls in WEDLIO</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-5">
                        <div class="card" style="width: 18rem;">
                            <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/cinnamon1.jpg" class="responsive"alt="Card image cap">
                            <div class="card-body">
                            <?php  echo anchor('vendor/receptions/cinnamon_grand', 'Cinnamon Grand, Colombo', ['class'=> 'btn btn-unique btn-sm'] ); ?> 
                    ...
                    <div class="card" style="width: 18rem;">
                    <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/jetwing2.jpg" class="responsive"alt="Card image cap">
                        <div class="card-body">
                        <?php  echo anchor('vendor/receptions/jetwingGalle', 'Jetwing Light House, Galle', ['class'=> 'btn btn-unique btn-sm'] ); ?> 
                        </div>
                    </div>
                    </div>
                    <!--Grid column-->
                    ...
                    <div class="col-md-4 mb-1">
                    <div class="card" style="width: 18rem;">
                    <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/citrus1.jpeg" alt="Card image cap">
                        <div class="card-body">
                        <?php  echo anchor('vendor/receptions/citrus', 'Citrus Waskaduwa', ['class'=> 'btn btn-unique btn-sm'] ); ?>
                        </div>
                    </div>
                    </div>
                    <!--Grid column-->
                     ...
                     <div class="col-md-4 mb-1">
                     <div class="card" style="width: 18rem;">
                     <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/kingsburry.jpg" alt="Card image cap">
                        <div class="card-body">
                        <?php  echo anchor('vendor/receptions/kingsbury', 'Kingsbury, Colombo', ['class'=> 'btn btn-unique btn-sm'] ); ?>
                        </div>
                    </div>
                    </div>
                    <!--Grid column-->
                     ...
                     <div class="col-md-4 mb-1">
                     <div class="card" style="width: 18rem;">
                     <img class="card-img-top img-fluid " src="<?php echo base_url(); ?>assets/homepage/wedlio_img/amari.jpg" alt="Card image cap">
                        <div class="card-body">
                        <?php  echo anchor('vendor/receptions/amari', 'Amari, Galle', ['class'=> 'btn btn-unique btn-sm'] ); ?>
                        </div>
                    </div>
                    </div>
                    <!--Grid column-->
                     ...
                     <div class="col-md-4 mb-1">
                     <div class="card" style="width: 18rem;">
                     <img class="card-img-top img-fluid" src="<?php echo base_url(); ?>assets/homepage/wedlio_img/amaya hills.jfif" alt="Card image cap">
                        <div class="card-body">
                        <?php  echo anchor('vendor/receptions/amayahills', 'Amaya Hills, Kandy', ['class'=> 'btn btn-unique btn-sm'] ); ?>
                        </div>
                    </div>
                    </div>
                    <!--Grid column-->
